...
float fireCooldownv ;//Time remaining until the player can fire again.

public:
void handleInput(const Input& input);// Processes user input (input) for movement and actions.
